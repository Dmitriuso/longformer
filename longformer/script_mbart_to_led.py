...
import logging
import os
#os.environ['PYTHONPATH'] += "/home/dmitri/Forschung/into_LED_conversion/longformer/longformer"
import copy

from transformers import MBartConfig
from transformers import AutoTokenizer, MBartTokenizer
from transformers import MBartForConditionalGeneration
from longformer_encoder_decoder import LongformerSelfAttentionForBart, LongformerEncoderDecoderForConditionalGeneration
...
def create_long_model(
    ...
    tokenizer = MBartTokenizer.from_pretrained(tokenizer_name_or_path)
