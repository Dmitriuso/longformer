...
from longformer_encoder_decoder import LongformerEncoderDecoderForConditionalGeneration, LongformerEncoderDecoderConfig
...
class SummarizationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_ids = self.tokenizer.encode(entry['text'], truncation=True, max_length=self.max_input_len)
